namespace TryAgainFSM.Actions
{
    ...
    public abstract class AIMovementActionHandler<TContext> : AIInstantActionHandler<TContext>
    {
        protected AIStateControl movement;

        public AIMovementActionHandler(AIStateControl movement)
