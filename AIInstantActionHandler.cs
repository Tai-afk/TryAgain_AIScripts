namespace TryAgainFSM.Actions
{
    ...
    public abstract class AIInstantActionHandler<TContext> : AIBaseActionHandler<TContext>
    {
        public override void StartAction(AICharacterController controller, object context)
        {
        ...
        protected override void _EndAction(AICharacterController controller)
        {
        }
    }
}