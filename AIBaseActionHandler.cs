...
namespace TryAgainFSM.Actions
{
    ...
    public abstract class AIBaseActionHandler<TContext> : AIActionHandler
    {
        /// <summary>
        ...
        /// </summary>
        public abstract bool CanStartAction(AICharacterController controller);
        ...
        public virtual void StartAction(AICharacterController controller, object context)
        {
        ...
        protected abstract void _StartAction(AICharacterController controller, TContext context);

        /// <summary>
        /// Placeholder method, see IActionHandler#CanEndAction.
        /// </summary>
        /// <returns></returns>
        public abstract bool CanEndAction(AICharacterController controller);
        ...
        /// </summary>
        /// <param name="controller">RPGCharacterController instance.</param>
        public virtual void EndAction(AICharacterController controller)
        {
        ...
        /// </summary>
        /// <param name="controller">RPGCharacterController instance.</param>
        protected abstract void _EndAction(AICharacterController controller);
    }
}